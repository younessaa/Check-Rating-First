...
public class MostViewedProductAdapter extends RecyclerView.Adapter<MostViewedProductAdapter.Viewholder> {
    ...
    public MostViewedProductAdapter(Context mContext, List<Product> mProducts) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.most_viewed_product_card, parent, false);
        return new MostViewedProductAdapter.Viewholder(view);
    }
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            productImage = itemView.findViewById(R.id.mv_image);
            name = itemView.findViewById(R.id.mv_name);
